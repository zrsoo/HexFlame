    ...
    private void ChangeFlameElement()
    {
        ...
        switch (burningElementDropdown.value)
        {
            ...
            case 0:
                ...
                GlobalFlameManager.instance.OnColorChanged(255.0f, 127.5f, 0.0f, 255.0f, 0.0f, 0.0f);
            ...
            case 1:
                ...
                GlobalFlameManager.instance.OnColorChanged(153.0f, 153.0f, 255.0f, 0.0f, 0.0f, 255.0f);
            ...
            case 2:
                ...
                GlobalFlameManager.instance.OnColorChanged(255.0f, 25.0f, 25.0f, 255.0f, 0.0f, 0.0f);
            ...
            case 3:
                ...
                GlobalFlameManager.instance.OnColorChanged(0.0f, 255.0f, 255.0f, 51.0f, 204.0f, 51.0f);
